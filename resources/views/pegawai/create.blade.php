          ...
          <div class="container">
            <form action="{{ url('/store') }}" method="POST">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" name="Nik_pegawai" placeholder="Masukkan NIP">
                  </div>
              </div>
              <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" name="no_hp" placeholder="Masukkan No. Telp">
                  </div>
              </div>
              <div class="form-group row">
